...
from .polyline import closest_point, point_at_station, sample_stations
...
def lane_widths(
    ...
    *,
    ...
    return build_profile(sts, widths, tolerance=tolerance), minimum
...
def road_elevation(
    ...
    *,
    ...
    return build_profile(sts, values, tolerance=tolerance)
